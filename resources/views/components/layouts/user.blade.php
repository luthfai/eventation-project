        ...
        <div class="min-h-screen text-gray-900 bg-gray-100 dark:bg-dark-eval-0 dark:text-gray-200">
            ...
            <aside class="fixed inset-y-0 z-20 flex flex-col py-4 space-y-6 bg-white shadow-lg dark:bg-dark-eval-1"
                ...
                <x-perfect-scrollbar as="nav" aria-label="main" class="flex flex-col flex-1 gap-4 px-3">
                    ...
                    <x-sidebar.link title="Dashboard" href="/dashboard" :isActive="request()->routeIs('admin.dash')">
                        <x-slot name="icon">
                            <x-icons.dashboard class="flex-shrink-0 w-6 h-6" aria-hidden="true" />
                        </x-slot>
                    </x-sidebar.link>
                    <x-sidebar.link title="Undanganku" href="/user/dashboard/event" :isActive="request()->routeIs('admin.undangan')">
                        <x-slot name="icon">
