    ...
    <div class="content">
        <div class="event-details">
            ...
            <ul>
                ...
                <li>Waktu Acara: {{ date('H:i', strtotime($event->start_date)) }} -
                    {{ date('H:i', strtotime($event->end_date)) }}</li>
        ...
        <div class="event-details">
            ...
            <div class="mapouter">
                <div class="gmap_canvas">
                    <iframe width="50%" height="500" id="gmap_canvas"
