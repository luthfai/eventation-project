                    ...
                    <div class="w-full xl:w-1/2 xl:pr-8">
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                ...
                                <h3 class="pl-12 mt-3 text-base justify-center font-medium leading-5 text-gray-800 truncate">E-Wallet/QRIZ <h3><br>
                    ...
                    <div class="w-full xl:w-1/2 xl:pr-8">
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                ...
                                <h3 class="pl-12 mt-3 text-base justify-center font-medium leading-5 text-gray-800 truncate">Outlet Ritel <h3><br>
