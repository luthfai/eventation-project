<x-layouts.super>
    ...
    <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
        <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <x-button href="{{ route('super.admin.create') }}" variant="warning" class="justify-center max-w-xs gap-2">
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-dark-eval-2">
                ...
                <tr class="text-sm text-gray-500 dark:text-dark-eval-3">
                    ...
                    <td class="px-4 py-3 flex text-sm font-medium text-gray-900 dark:text-dark-eval-3">
                        <x-button href="{{ route('super.admin.edit', $admin->id) }}" variant="info" class="justify-center text-center max-w-xs gap-2 mx-2">
