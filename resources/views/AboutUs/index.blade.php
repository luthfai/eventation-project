...
@section('content')
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-8">
                                <div class="relative pl-12">
                                    ...
                                    <h2 class="mt-2 text-base text-gray-600">"I direct a team with a clear vision towards
                                        achieving the desired goal."
                                    </h2>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Aido Luthfi Al
                                    Hakim
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <h2 class="mt-2 text-base text-gray-600">"I am a digital architect who creates
                                        attractive and easy-to-use interfaces."</h2>
                                </div>
                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Brilliyand
                                    Noval Herdana Putra
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <h2 class="mt-2 text-base text-gray-600">"I am the project governance custodian,
                                        ensuring all administrative aspects run smoothly and on time."
                                    </h2>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Evi Amalia
                                    Midfia
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Project
                                        Administrator</span>
                                </h3>
                                ...
                                <div class="flex justify-start pl-12 mt-3">
                                    <a class="flex items-center block mr-6 text-gray-400 no-underline hover:text-gray-600"
                                        ...
                                        href="https://www.facebook.com/evy.amalia.319">
                                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M23.998 12c0-6.628-5.372-12-11.999-12C5.372 0 0 5.372 0 12c0 5.988 4.388 10.952 10.124 11.852v-8.384H7.078v-3.469h3.046V9.356c0-3.008 1.792-4.669 4.532-4.669 1.313 0 2.686.234 2.686.234v2.953H15.83c-1.49 0-1.955.925-1.955 1.874V12h3.328l-.532 3.469h-2.796v8.384c5.736-.9 10.124-5.864 10.124-11.853z" />
                                    ...
                                    <a class="flex items-center block text-gray-400 no-underline hover:text-gray-600"
                                        target="_blank" rel="noopener noreferrer" href="https://github.com/evi03">
                                        <svg viewBox="0 0 24 24" class="w-5 h-5 fill-current"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" />
                        ...
                        <blockquote
                            ...
                            <div class="flex flex-col pr-10">
                                <div class="relative pl-12">
                                    ...
                                    <h2 class="mt-2 text-base text-gray-600">"I'm the quality control and marketing team
                                        that makes sure every element of website design and functionality works flawlessly"
                                    </h2>
                                </div>

                                <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">M.Rizky
                                    Mafazan
                                    <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- Web Marketing & Design
                                        Tester
                                    </span>
                                </h3>
                    ...
                    <blockquote
                        ...
                        <div class="flex flex-col pr-8">
                            <div class="relative pl-12">
                                ...
                                <h2 class="mt-2 text-base text-gray-600">"I am the guardian of quality to ensure the
                                    existing systems and processes run well and meet the set quality standards."
                                </h2>
                            </div>

                            <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">Mellyana Tundjung
                                <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- System Analyst & Quality
                                    Control
                                </span>
                            </h3>
    ...
    <div id="testimonials"
        class="flex items-center justify-center w-full px-8 py-10 border-t border-gray-200 md:py-16 lg:py-16 xl:py-16 xl:px-0">
        <div class="max-w-6xl mx-auto">
            <div class="flex-col items-center ">
                <div class="flex flex-col items-center justify-center w-full h-full max-w-2xl pr-8 mx-auto text-center">
                    <p class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase">We are
                    </p>
                    <h2
